...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "com.pluralsight.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.pluralsight.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.pluralsight.notekeeper.extra.NOTE_ID";
